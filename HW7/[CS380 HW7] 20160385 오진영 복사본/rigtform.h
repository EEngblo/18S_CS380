...
inline RigTForm catmullRom(const RigTForm& prevRbt, const RigTForm& startRbt, const RigTForm& endRbt, const RigTForm& nextRbt, const float alpha){

  Cvec3 trans = catmullRom(prevRbt.getTranslation(), startRbt.getTranslation(), endRbt.getTranslation(), nextRbt.getTranslation(), alpha);
  Quat rot = catmullRom(prevRbt.getRotation(), startRbt.getRotation(), endRbt.getRotation(), nextRbt.getRotation(), alpha);
